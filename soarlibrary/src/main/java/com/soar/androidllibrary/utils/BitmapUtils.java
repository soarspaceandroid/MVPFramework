 ...
 */
package com.soar.androidllibrary.utils;
...
public final class BitmapUtils {
    ...
    public static Bitmap getBitmapFromView2(View view) {
        ...
        if (cacheBitmap == null) {
            if (DEBUG) {
                android.util.Log.e(TAG, "failed getViewBitmap(" + view + ")",
    ...
    public static Bitmap blur(Context context, Bitmap sentBitmap, int radius) {
        ...
        if (radius < 0) {
            radius = 0;
            if (DEBUG) {
                Log.w("radius must be 0 < r < 25 , forcing radius=0");
            }
        } else if (radius > 25) {
            radius = 25;
            if (DEBUG) {
                Log.w("radius must be 0 < r < 25 , forcing radius=25");
            }
        }
